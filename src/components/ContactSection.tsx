      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        <div className="md:py-4">
          ...
          <p className="mt-4 text-pretty text-gray-700">
            Have questions about solar energy solutions? Our team is here to help you harness the power of the sun.
            Contact us today to discuss your project and discover how we can make clean energy accessible for you.
          </p>
          ...
          <dl className="mt-6 space-y-3">
            ...
            <div>
              ...
              <dd className="grid grid-cols-[24px_1fr] items-center gap-2 text-gray-700">
                ...
                <span className="font-medium">info@solarsite.com</span>
              </dd>
            </div>
            ...
            <div>
              ...
              <dd className="grid grid-cols-[24px_1fr] items-center gap-2 text-gray-700">
                ...
                <span className="font-medium">123 Solar Ave, Sun City, USA</span>
              </dd>
            </div>
          </dl>
        </div>
        ...
        <form action="#" className="space-y-4 rounded-lg border border-gray-300 bg-gray-100 p-6">
          <div>
            ...
            <input className="mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:outline-none" id="name" type="text" placeholder="Your name" />
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-900" htmlFor="email">Email</label>

            <input className="mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:outline-none" id="email" type="email" placeholder="Your email" />
          </div>
