...
export default function AboutSection() {
    return (
        <section className="flex flex-col max-md:gap-20 md:flex-row items-center justify-between gap-10 py-16 px-4 md:px-16 lg:px-24 xl:px-32">
            <div className="relative shadow-2xl shadow-indigo-600/40 rounded-2xl overflow-hidden shrink-0 w-full md:w-1/2 h-64 md:h-[420px]">
                <Image className="w-full h-full object-cover rounded-2xl"
                    src="https://images.unsplash.com/photo-1531497865144-0464ef8fb9a9?q=80&w=1280&h=720&auto=format&fit=crop"
                    alt="Solar energy team" width={1280} height={720} />
            </div>
            <div className="text-sm text-slate-600 md:w-1/2 max-w-lg">
